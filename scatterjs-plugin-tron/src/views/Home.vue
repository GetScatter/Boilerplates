  ...
  <section class="example">
    ...
    <section class="container">
      ...
      <section class="contract">
        ...
        <p>
          This website is a Tron/Scatter boilerplate demo. You can use it to understand how Scatter should be implemented,
          and how Tron interacts with a user's Scatter.
        </p>
        <br>
        ...
        <button @click="login" v-if="scatter && !address">Login with Scatter</button>
        <section class="logged-in-with" v-if="scatter && address">
...
<script>
    ...
    // Importing contract data for the example message board
    // https://github.com/TronWatch/TronLink-Demo-Messages/
    import contracts from '../data/contracts.json';
    const contractData = contracts['TRXMessages.sol:TRXMessages'];

    // Importing Scatter and TronWeb.
    ...
    // Scatter comes without plugins, so we need to add the TronWeb plugin.
    ...
    export default {
        ...
        mounted(){
            // We're going to setup TronWeb now.
        ...
        computed:{
            ...
            address(){
                ...
                // Returning the Tron account
                return this.scatter.identity.accounts[0].address;
            },
        },
        ...
        methods:{
            ...
            postMessage(){
                ...
                this.result = null;
                const message = this.messageToPost.trim();
                if(!message.length) return this.result = 'Error: Empty Message';
                this.posting = true;

                // Posting a message to the chain, signing with Scatter.
                this.contract.postMessage(message).send({
